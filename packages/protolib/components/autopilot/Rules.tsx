...
export const RuleItem = ({ value, loading, onDelete, onEdit, availableParams = [], allowParams = false, onBlur = (e) => { }, readOnly = false, ...props }) => {
  return (
      ...
      {!(disabledConfig["enabled"] === false) ? <>
        <XStack gap="$3" width="100%" f={1} {...borderStyles} data-tour="rules-textarea">
          <BoardTextArea
            ...
            disabled={isLoadingOrGenerating || readOnly}
            readOnly={readOnly}
                ...
                <XStack gap="$2" flexShrink={0}>
                  ...
                  >
                    <Button
                      ...
                      icon={X}
                      scaleIcon={1.4}
                      onPress={readOnly ? undefined : () => { setDraftAt(0, rules[0] || ""); setErrorMsg(null); }}
                      disabled={readOnly}
                    />
                  </TooltipSimple>}
                  <TooltipSimple
                  ...
                  >
                    <Button
                      size="$3"
                      p="$0"
                      disabled={isLoadingOrGenerating || !ruleHasChanged || readOnly}
                      onMouseDown={(e) => e.stopPropagation()}
                      ...
                      scaleIcon={1.4}
                      onPress={readOnly ? undefined : editFirstRule}
                    />
                  </TooltipSimple>
                </XStack>
              </XStack>
