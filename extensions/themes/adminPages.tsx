...
const defaultTint = SiteConfig?.ui?.defaultTint ?? 'blue'
...
export default {
  'themes': {
    component: ({ pageState, initialItems, pageSession, extraData }: any) => {
      ...
      const canUpdate = useHasPermission('themes.update')
          ...
          extraMenuActions={[
            {
              ...
              action: async (element: ThemeType) => {
                ...
                let updateData: any = {
                  ...
                  accent: element.get("accent") ?? defaultTint
                }
                ...
                // If in iframe, notify parent to reload; otherwise reload directly
                if (window.parent !== window) {
                  sendToPageBus({ type: 'theme-changed' })
                } else {
                  document.location.reload()
                }
              },
              isVisible: (ele: ThemeType) => canUpdate,
              menus: ["item"]
            }
          ]}
        />
