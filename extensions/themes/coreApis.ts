...
import { AutoAPI, getRoot, handler, requirePermission } from 'protonode'
...
export default (app, context) => {
    ...
    app.post('/api/core/v1/themes/update-css', handler(async (req, res, session) => {
        hasPermission(session, 'themes.update')
    ...
    app.get('/api/core/v1/themes/get-fonts-css', requirePermission('themes.read'), async (req, res) => {
