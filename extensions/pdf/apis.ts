import { requirePermission, getServiceToken, getRoot } from 'protonode'
...
export default async (app, context) => {
    app.get('/api/v1/pdf/getTotalPages', requirePermission('files.read'), async (req, res) => {
    ...
    app.get('/api/v1/pdf/dumpPages', requirePermission('files.create'), async (req, res) => {
