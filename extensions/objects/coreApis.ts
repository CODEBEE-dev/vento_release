...
import { handler, requirePermission, getSourceFile, extractChainCalls, getDefinition, AutoAPI, getRoot, addFeature, toSourceFile, getObjectCardDefinitions } from 'protonode'
...
export default (app, context) => {
  ...
  app.post('/api/core/v1/objects/parseKeys', requirePermission('objects.read'), handler(async (req, res) => {
    const { code } = req.body || {}
