...
import { Mail, Tag, Key, User, Users, Globe } from '@tamagui/lucide-icons';
...
const UserIcons = { username: Mail, type: Tag, passwod: Key, repassword: Key, network: Globe }
    ...
    return (
        <DataView
            ...
            columns={DataTable2.columns(
                ...
                DataTable2.column("network", row => row.network, "network", row => <Chip text={row.network?.toUpperCase() || 'VENTO'} color={'$blue5'} />),
