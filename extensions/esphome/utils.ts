...
export const downloadDeviceOtaEndpoint = (targetDevice, compileSessionId) => {
    return (`${onlineCompiler}/api/v1/device/downloadOta/${targetDevice}?compileSessionId=${compileSessionId}`)
};
