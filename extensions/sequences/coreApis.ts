...
import { getLogger, hasPermission } from 'protobase'
...
export default (app, context) => {
    ...
    app.get('/api/core/v1/sequences/:sequenceId', handler(async (req, res, session) => {
        hasPermission(session, 'sequences.read')
    ...
    app.post('/api/core/v1/sequences/:sequenceId', handler(async (req, res, session) => {
        hasPermission(session, 'sequences.update')
        const sequenceId = req.params.sequenceId
