...
if (fs.existsSync(packagePath)) {
    ...
    if(!packageJson.workspaces.includes('packages/protoflow')) {
        packageJson.workspaces.push('packages/protoflow');
    }
    if(!packageJson.workspaces.includes('packages/protolib')) {
        packageJson.workspaces.push('packages/protolib');
    }
    if(!packageJson.workspaces.includes('packages/ui')) {
        packageJson.workspaces.push('packages/ui');
    }
    if(!packageJson.workspaces.includes('packages/visualui')) {
        packageJson.workspaces.push('packages/visualui');
    }
